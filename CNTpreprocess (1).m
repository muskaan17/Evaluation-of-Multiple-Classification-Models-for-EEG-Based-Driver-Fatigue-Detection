...
path = '/MATLAB Drive/EEG_DriverFatigue-master/figshare_Data/'; %path to EEG data folders /1, /2, ..., /11
file = {'Normal state.cnt'; 'Fatigue state.cnt'}; %Select States to analyze
patients = 4; %SELECT Patient(s)
Channels = 8; %Select relevant Channels from Channel info (Channel TP7: 22)
